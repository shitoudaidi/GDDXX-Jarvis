...
// ---- 工具分组 ----
//
// core：任何场景都注入。ACUI 工具默认带上（贾维斯侧 Phase 1 决策，组件少 token 便宜）。
const CORE_TOOLS = [
  'send_message',
  'recall_memory',
  ...
  'find_tool',
  'ui_show', 'ui_update', 'ui_hide', 'ui_patch',
]
...
const WORLDCUP_TOOLS    = [...WEB_TOOLS]
...
const PERSON_CARD_TOOLS = [...WEB_TOOLS]
const FOCUS_BANNER_TOOLS = []
const ADMIN_TOOLS       = [
...
export function selectTools(ctx = {}) {
  ...
  // 保活只覆盖贾维斯的"已知工具"——installed 工具走单独的全注入路径。
